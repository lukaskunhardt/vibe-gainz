    ...
    <div className="space-y-2 sm:space-y-4">
      ...
      <div className="rounded-2xl border-4 border-foreground/80 bg-muted/40 p-3 shadow-[0_4px_0_0_rgba(0,0,0,0.1)] sm:p-6">
        ...
        <div className="mb-3 text-center sm:mb-6">
          <div
            className="inline-block rounded-2xl border-4 px-5 py-2 shadow-[0_3px_0_0_rgba(0,0,0,0.15)] transition-all sm:px-8 sm:py-4"
            style={{
              backgroundColor: color,
              borderColor: color,
            }}
          >
            <div className="text-4xl font-bold text-white sm:text-6xl">{value || "-"}</div>
          </div>
        </div>
      ...
      {value > 0 && (
        <div className="border-3 rounded-xl border-foreground/20 bg-muted/60 p-1.5 text-center sm:p-3">
          <p className="text-xs font-semibold text-foreground">{RPE_DESCRIPTIONS[value]}</p>
        </div>
      )}
    </div>
  );
